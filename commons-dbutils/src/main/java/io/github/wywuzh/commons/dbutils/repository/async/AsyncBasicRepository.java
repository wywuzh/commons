...
import io.github.wywuzh.commons.dbutils.handlers.ColumnHandler;
...
public class AsyncBasicRepository<E extends AbstractEntity, V extends AbstractVo> {
     ...
     * @throws SQLException
     */
    public int update(String tableName, String columnSql, Object[] values, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public int update(String tableName, String columnSql, Object[] values, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public int update(String tableName, String[] columns, Object[] values, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notEmpty(columns, "columns must not be empty");
     ...
     * @throws SQLException
     */
    public int update(String tableName, String[] columns, Object[] values, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notEmpty(columns, "columns must not be empty");
     ...
     * @throws SQLException
     */
    public List<E> queryForList(String tableName, String columnSql, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
        ...
        Connection connection = DataSourceUtils.getConnection(getDataSource());
        try {
            return asyncQueryRunner.query(connection, sql, new BeanListHandler<E>(getEntityClass()), conditionObjs).get();
        } catch (InterruptedException e) {
            logger.error(e);
        } catch (ExecutionException e) {
            logger.error(e);
     ...
     * @throws SQLException
     */
    public List<E> queryForList(String tableName, String columnSql, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public List<E> queryForList(String tableName, String columnSql, String conditionSql, Object[] conditionObjs, Sort[] sorts) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
        ...
        Connection connection = DataSourceUtils.getConnection(getDataSource());
        try {
            return asyncQueryRunner.query(connection, querySql.toString(), new BeanListHandler<E>(getEntityClass()), conditionObjs).get();
        } catch (InterruptedException e) {
            logger.error(e);
        } catch (ExecutionException e) {
            logger.error(e);
     ...
     * @throws SQLException
     */
    public List<E> queryForList(String tableName, String columnSql, String[] conditionColumns, Object[] conditionObjs, Sort[] sorts) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public Long queryForLong(String tableName, String column, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
     ...
     * @throws SQLException
     */
    public Long queryForLong(String tableName, String column, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public Double queryForDouble(String tableName, String column, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public Double queryForDouble(String tableName, String column, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public Integer queryForInteger(String tableName, String column, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public Integer queryForInteger(String tableName, String column, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public BigDecimal queryForBigDecimal(String tableName, String column, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public BigDecimal queryForBigDecimal(String tableName, String column, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public String queryForString(String tableName, String column, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public String queryForString(String tableName, String column, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(column, "column must not be null");
     ...
     * @throws SQLException
     */
    public <T> T queryForObject(String tableName, String columnSql, String conditionSql, Object[] conditionObjs, ResultSetHandler<T> rsh) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public <T> T queryForObject(String tableName, String columnSql, String[] conditionColumns, Object[] conditionObjs, ResultSetHandler<T> rsh) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public Map<String, Object> queryForMap(String tableName, String columnSql, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public Map<String, Object> queryForMap(String tableName, String columnSql, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public List<Map<String, Object>> queryForMapList(String tableName, String columnSql, String conditionSql, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
     ...
     * @throws SQLException
     */
    public List<Map<String, Object>> queryForMapList(String tableName, String columnSql, String[] conditionColumns, Object[] conditionObjs) throws SQLException {
        Assert.notNull(tableName, "tableName must not be null");
        Assert.notNull(columnSql, "columnSql must not be null");
