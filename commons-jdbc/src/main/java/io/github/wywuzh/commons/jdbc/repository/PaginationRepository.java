...
public class PaginationRepository<E extends AbstractEntity, V extends AbstractVo> extends BasicRepository<E, V> {
     ...
     */
    public PaginationObject<E, V> findPaginationObjectByNativeSQL(String tableName, String columns, String conditionSql, Object[] conditionObjs, PaginationParameter<V> paginationParameter,
        ...
        // 查询分页列表
        StringBuilder resultListSql = new StringBuilder(MessageFormat.format(Sql.QUERY, columns, tableName, conditionSql));
        /*
         * // 添加排序信息
     ...
     */
    public PaginationObject<E, V> findPaginationObjectByNativeSQL(String tableName, String columns, String[] conditionColumns, Object[] conditionObjs, PaginationParameter<V> paginationParameter,
            RowMapper<E> rowMapper) throws SQLException {
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
        }
        return this.findPaginationObjectByNativeSQL(tableName, columns, conditionSql.toString(), conditionObjs, paginationParameter, rowMapper);
    }
     ...
     */
    @Deprecated
    public PaginationObject<E, V> findPaginationObjectByNativeSQL(String tableName, String columns, String conditionSql, Object[] conditionObjs, Map<String, String> sortMap,
     ...
     */
    @Deprecated
    public PaginationObject<E, V> findPaginationObjectByNativeSQL(String tableName, String columns, String[] conditionColumns, Object[] conditionObjs, Map<String, String> sortMap,
            PaginationParameter<V> paginationParameter, RowMapper<E> rowMapper) {
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
        }
        return this.findPaginationObjectByNativeSQL(tableName, columns, conditionSql.toString(), conditionObjs, sortMap, paginationParameter, rowMapper);
    }
     ...
     */
    public PaginationObject<E, V> findPaginationObjectByNativeSQL(String tableName, String sql, Object[] conditionObjs, PaginationParameter<V> paginationParameter, RowMapper<E> rowMapper) {
        // 查询数据总数
