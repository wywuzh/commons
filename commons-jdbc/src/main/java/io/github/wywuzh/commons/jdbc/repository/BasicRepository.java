 ...
 */
package io.github.wywuzh.commons.jdbc.repository;
...
import io.github.wywuzh.commons.jdbc.Sql;
import io.github.wywuzh.commons.jdbc.entity.AbstractEntity;
import io.github.wywuzh.commons.jdbc.vo.AbstractVo;
import io.github.wywuzh.commons.pager.Page;
...
public class BasicRepository<E extends AbstractEntity, V extends AbstractVo> {
     ...
     * @return
     */
    public int update(String tableName, String columnSql, Object[] values, String[] conditionColumns, Object[] conditionObjs) {
        // 封装条件
     ...
     * @return
     */
    public int update(String tableName, String[] columns, Object[] values, String[] conditionColumns, Object[] conditionObjs) {
        // 封装要修改的字段
        StringBuilder columnSql = new StringBuilder();
        for (int i = 0; i < columns.length; i++) {
            if (columnSql.length() > 0) {
     ...
     * @return
     */
    public int[] batchUpdate(String tableName, String columnSql, List<Object[]> valuesList, String conditionSql, List<Object[]> conditionObjsList) {
        // 封装要修改的字段
        String sql = MessageFormat.format(Sql.UPDATE, tableName, columnSql, conditionSql);
     ...
     * @return
     */
    public int[] batchUpdate(String tableName, String columnSql, List<Object[]> valuesList, String[] conditionColumns, List<Object[]> conditionObjsList) {
        // 封装条件
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
     ...
     * @return
     */
    public int[] batchUpdate(String tableName, String[] columns, List<Object[]> valuesList, String conditionSql, List<Object[]> conditionObjsList) {
        // 封装要修改的字段
        StringBuilder columnSql = new StringBuilder();
        for (int i = 0; i < columns.length; i++) {
            if (columnSql.length() > 0) {
     ...
     * @return
     */
    public int[] batchUpdate(String tableName, String[] columns, List<Object[]> valuesList, String[] conditionColumns, List<Object[]> conditionObjsList) {
        // 封装要修改的字段
        StringBuilder columnSql = new StringBuilder();
        for (int i = 0; i < columns.length; i++) {
            if (columnSql.length() > 0) {
        ...
        return this.batchUpdate(tableName, columnSql.toString(), valuesList, conditionSql.toString(), conditionObjsList);
    }
     ...
     * @return
     */
    public List<E> findEntityListByParam(String tableName, String columns, String conditionSql, Object[] conditionObjs, RowMapper<E> rowMapper) {
        String sql = MessageFormat.format(Sql.QUERY, columns, tableName, conditionSql);
     ...
     * @return
     */
    public List<E> findEntityListByParam(String tableName, String columns, String[] conditionColumns, Object[] conditionObjs, RowMapper<E> rowMapper) {
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
        }
     ...
     * @return
     */
    public List<E> findEntityListByParam(String tableName, String columns, String conditionSql, Object[] conditionObjs, List<Sort> sorts, RowMapper<E> rowMapper) {
        String sql = MessageFormat.format(Sql.QUERY, columns, tableName, conditionSql);
     ...
     * @return
     */
    public List<E> findEntityListByParam(String tableName, String columns, String[] conditionColumns, Object[] conditionObjs, List<Sort> sorts, RowMapper<E> rowMapper) {
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
        }
     ...
     * @return
     */
    public List<E> findEntityPagerByParam(String tableName, String columns, String conditionSql, Object[] conditionObjs, Page page, RowMapper<E> rowMapper) {
        String sql = MessageFormat.format(Sql.QUERY, columns, tableName, conditionSql);
        sql = sql + " LIMIT ?,?";
        // 组装查询条件
     ...
     * @return
     */
    public List<E> findEntityPagerByParam(String tableName, String columns, String[] conditionColumns, Object[] conditionObjs, Page page, RowMapper<E> rowMapper) {
        StringBuilder conditionSql = new StringBuilder();
        for (int i = 0; i < conditionColumns.length; i++) {
            conditionSql.append(" AND ").append(conditionColumns[i]).append("=?");
        }
