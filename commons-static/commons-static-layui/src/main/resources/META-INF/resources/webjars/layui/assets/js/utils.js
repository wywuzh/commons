...
layui.use(["element", "table", "form", "jquery"], function () {
    ...
    jquery(document).on("click", ".layui-table-body table.layui-table tbody tr", function () {
        ...
        var tableBox = jquery(this).parents('.layui-table-box');
        var tableDiv;
        //存在固定列
    ...
    jquery(document).on("click", "td div.laytable-cell-checkbox div.layui-form-checkbox", function (e) {
        e.stopPropagation();
    });
...
function initDatatable(selector, options) {
    ...
    var defaultOptions = {
        ...
        toolbar: '#toolbar', // 开启表格头部工具栏区域。layui 2.4.0 开始新增。若需要“列显示隐藏”、“导出”、“打印”等功能，则必须开启该参数
