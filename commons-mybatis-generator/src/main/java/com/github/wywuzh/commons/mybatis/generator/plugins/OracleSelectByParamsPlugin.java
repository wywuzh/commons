...
/**
 * 类OracleSelectByParamsPlugin的实现描述：自定义select查询插件(Oracle)
 *
 * @author <a href="mailto:wywuzh@163.com">伍章红</a> 2022-11-17 15:31:34
 * @version v2.7.0
 * @since JDK 1.8
 */
public class OracleSelectByParamsPlugin extends SelectByParamsPlugin {
