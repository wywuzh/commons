...
public class UpsertPlugin extends BasePlugin {
  ...
  public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
    // ====================================== upsert ======================================
    Method mUpsert = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
    ...
    if (introspectedTable.hasBLOBColumns()) {
      Method mUpsertWithBLOBs = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT_WITH_BLOBS, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
    ...
    Method mUpsertSelective = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT_SELECTIVE, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
    ...
    if (this.allowMultiQueries) {
      // ====================================== upsertByExample ======================================
      Method mUpsertByExample = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT_BY_EXAMPLE, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
      ...
      // !!! 注意这里的行为不以有没有生成Model 的 WithBLOBs类为基准
      if (introspectedTable.hasBLOBColumns()) {
        Method mUpsertByExampleWithBLOBs = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT_BY_EXAMPLE_WITH_BLOBS, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
      ...
      Method mUpsertByExampleSelective = JavaElementGeneratorTools.generateMethod(METHOD_UPSERT_BY_EXAMPLE_SELECTIVE, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
    ...
    if (this.allowBatchUpsert) {
      ...
      Method mBatchUpsert = JavaElementGeneratorTools.generateMethod(METHOD_BATCH_UPSERT, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
      ...
      if (introspectedTable.hasBLOBColumns()) {
        ...
        Method mBatchUpsertWithBLOBs = JavaElementGeneratorTools.generateMethod(METHOD_BATCH_UPSERT_WITH_BLOBS, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
            new Parameter(returnType, "list", "@Param(\"list\")"));
      ...
      Method mBatchUpsertSelective = JavaElementGeneratorTools.generateMethod(METHOD_BATCH_UPSERT_SELECTIVE, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
          new Parameter(returnType, "list", "@Param(\"list\")"), new Parameter(selectiveType, "selective", "@Param(\"selective\")", true));
  ...
  private void generateBatchXmlElement(Document document, IntrospectedTable introspectedTable, boolean withBLOBs) {
    ...
    while (columnIterator.hasNext()) {
      ...
      insertEle.addElement(new TextElement(
          MyBatis3FormattingUtilities.getEscapedColumnName(column) + " = values(" + MyBatis3FormattingUtilities.getEscapedColumnName(column) + ")" + (columnIterator.hasNext() ? "," : "")));
    }
  ...
  private void generateXmlElement(Document document, IntrospectedTable introspectedTable, boolean withBLOBs) {
    ...
    // 参数类型
    insertEle.addAttribute(new Attribute("parameterType", withBLOBs ? JavaElementGeneratorTools.getModelTypeWithBLOBs(introspectedTable).getFullyQualifiedName()
