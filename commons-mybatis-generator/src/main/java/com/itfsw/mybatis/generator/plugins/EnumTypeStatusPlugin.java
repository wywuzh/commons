...
public class EnumTypeStatusPlugin extends BasePlugin implements ILogicalDeletePluginHook {
  ...
  public static class EnumInfo {
    ...
    public EnumInfo(IntrospectedColumn column) throws NotSupportTypeException, CannotParseException {
      ...
      if (!(Short.class.getTypeName().equals(javaType) || Integer.class.getTypeName().equals(javaType) || Long.class.getTypeName().equals(javaType) || Boolean.class.getTypeName().equals(javaType)
          || Double.class.getTypeName().equals(javaType) || Float.class.getTypeName().equals(javaType) || BigDecimal.class.getTypeName().equals(javaType) || Byte.class.getTypeName().equals(javaType)
