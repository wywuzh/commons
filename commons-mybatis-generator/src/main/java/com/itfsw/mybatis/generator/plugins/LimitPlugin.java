...
public class LimitPlugin extends BasePlugin implements ISelectSelectivePluginHook {
  ...
  public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
    ...
    // 提供几个快捷方法
    Method setLimit = JavaElementGeneratorTools.generateMethod("limit", JavaVisibility.PUBLIC, topLevelClass.getType(), new Parameter(integerWrapper, "rows"));
    ...
    Method setLimit2 = JavaElementGeneratorTools.generateMethod("limit", JavaVisibility.PUBLIC, topLevelClass.getType(), new Parameter(integerWrapper, "offset"),
    ...
    Method setPage = JavaElementGeneratorTools.generateMethod("page", JavaVisibility.PUBLIC, topLevelClass.getType(), new Parameter(integerWrapper, "page"), new Parameter(integerWrapper, "pageSize"));
    commentGenerator.addGeneralMethodComment(setPage, introspectedTable);
    setPage = JavaElementGeneratorTools.generateMethodBody(setPage, "this.offset = " + (this.startPage == 0 ? "page" : "(page - " + this.startPage + ")") + " * pageSize;", "this.rows = pageSize;",
        "return this;");
