  ...
  public void initialized(IntrospectedTable introspectedTable) {
    ...
    if (this.logicalDeleteColumn != null) {
      ...
      try {
        ...
        this.logicalDeleteColumn = null;
        warnings.add(
            "itfsw(逻辑删除插件):" + introspectedTable.getFullyQualifiedTable() + "逻辑删除列(" + introspectedTable.getTableConfigurationProperty(PRO_LOGICAL_DELETE_COLUMN) + ")的类型不在支持范围（请使用数字列，字符串列，布尔列）！");
  ...
  public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
    if (this.logicalDeleteColumn != null) {
      ...
      if (introspectedTable.hasPrimaryKeyColumns()) {
        ...
        // hook
        PluginTools.getHook(ILogicalDeletePluginHook.class).sqlMapLogicalDeleteByPrimaryKeyElementGenerated(document, logicalDeleteByPrimaryKey, this.logicalDeleteColumn, this.logicalDeleteValue,
            introspectedTable);
