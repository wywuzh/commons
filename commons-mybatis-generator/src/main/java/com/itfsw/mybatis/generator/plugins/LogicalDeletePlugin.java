...
public class LogicalDeletePlugin extends BasePlugin {
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        ...
        if (this.logicalDeleteColumn != null) {
            ...
            try {
                ...
                this.logicalDeleteColumn = null;
                warnings.add("itfsw(逻辑删除插件):" + introspectedTable.getFullyQualifiedTable() + "逻辑删除列(" + introspectedTable.getTableConfigurationProperty(PRO_LOGICAL_DELETE_COLUMN)
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        if (this.logicalDeleteColumn != null) {
            // 1. 逻辑删除ByExample
            Method mLogicalDeleteByExample = JavaElementGeneratorTools.generateMethod(METHOD_LOGICAL_DELETE_BY_EXAMPLE, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance(),
            ...
            if (introspectedTable.hasPrimaryKeyColumns()) {
                // 2.1. 逻辑删除ByExample
                Method mLogicalDeleteByPrimaryKey = JavaElementGeneratorTools.generateMethod(METHOD_LOGICAL_DELETE_BY_PRIMARY_KEY, JavaVisibility.DEFAULT, FullyQualifiedJavaType.getIntInstance());
                commentGenerator.addGeneralMethodComment(mLogicalDeleteByPrimaryKey, introspectedTable);

                // 2.2 增强selectByPrimaryKey
                Method mSelectByPrimaryKey = JavaElementGeneratorTools.generateMethod(METHOD_SELECT_BY_PRIMARY_KEY_WITH_LOGICAL_DELETE, JavaVisibility.DEFAULT,
                ...
                mSelectByPrimaryKey.addParameter(new Parameter(FullyQualifiedJavaType.getBooleanPrimitiveInstance(), PARAMETER_LOGICAL_DELETED, "@Param(\"" + PARAMETER_LOGICAL_DELETED + "\")"));
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        if (this.logicalDeleteColumn != null) {
            ...
            // hook
            PluginTools.getHook(ILogicalDeletePluginHook.class).sqlMapLogicalDeleteByExampleElementGenerated(document, logicalDeleteByExample, this.logicalDeleteColumn, this.logicalDeleteValue,
                    introspectedTable);
            ...
            if (introspectedTable.hasPrimaryKeyColumns()) {
                ...
                // hook
                PluginTools.getHook(ILogicalDeletePluginHook.class).sqlMapLogicalDeleteByPrimaryKeyElementGenerated(document, logicalDeleteByPrimaryKey, this.logicalDeleteColumn,
                        this.logicalDeleteValue, introspectedTable);
    ...
    public boolean modelFieldGenerated(Field field, TopLevelClass topLevelClass, IntrospectedColumn introspectedColumn, IntrospectedTable introspectedTable, ModelClassType modelClassType) {
        if (this.logicalDeleteColumn != null) {
            ...
            if (this.logicalDeleteColumn.getJavaProperty().equals(field.getName())) {
                ...
                Method mAndLogicalDeleted = JavaElementGeneratorTools.generateMethod(METHOD_LOGICAL_DELETED, JavaVisibility.PUBLIC, null,
                ...
                // 3. 添加逻辑删除常量
                if (this.enableLogicalDeleteConst) {
                    Field logicalUnDeleteConstField = JavaElementGeneratorTools.generateStaticFinalField(this.logicalUnDeleteConstName, this.logicalDeleteColumn.getFullyQualifiedJavaType(),
                            this.getEnumConstantValue(false));
                    commentGenerator.addFieldComment(logicalUnDeleteConstField, introspectedTable);
                    Field logicalDeleteConstField = JavaElementGeneratorTools.generateStaticFinalField(this.logicalDeleteConstName, this.logicalDeleteColumn.getFullyQualifiedJavaType(),
