...
public class SelectSelectivePlugin extends BasePlugin implements ISelectOneByExamplePluginHook {
    ...
    public boolean clientSelectByExampleWithBLOBsMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        FormatTools.addMethodWithBestPosition(interfaze, this.replaceMethodWithSelective(method, METHOD_SELECT_BY_EXAMPLE_SELECTIVE, "@Param(\"example\")", introspectedTable));
    ...
    public boolean clientSelectByPrimaryKeyMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        if (introspectedTable.getRules().generatePrimaryKeyClass()) {
            FormatTools.addMethodWithBestPosition(interfaze, this.replaceMethodWithSelective(method, METHOD_SELECT_BY_PRIMARY_KEY_SELECTIVE, "@Param(\"record\")", introspectedTable));
        } else {
            ...
            for (IntrospectedColumn introspectedColumn : introspectedTable.getPrimaryKeyColumns()) {
                withSelective
                        .addParameter(new Parameter(introspectedColumn.getFullyQualifiedJavaType(), introspectedColumn.getJavaProperty(), "@Param(\"" + introspectedColumn.getJavaProperty() + "\")"));
            }
            // selective
            withSelective.addParameter(new Parameter(this.getModelColumnFullyQualifiedJavaType(introspectedTable), "selective", "@Param(\"selective\")", true));
    ...
    public boolean clientSelectOneByExampleWithBLOBsMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        FormatTools.addMethodWithBestPosition(interfaze, this.replaceMethodWithSelective(method, METHOD_SELECT_ONE_BY_EXAMPLE_SELECTIVE, "@Param(\"example\")", introspectedTable));
        return true;
    }
