...
public class BaseMapperPlugin extends BasePlugin {
    private static final String DEFAULT_DAO_SUPER_CLASS = "com.wuzh.commons.mybatis.generator.mapper.BaseMapper";
    private static final String DEFAULT_DAO_SUPER_CLASS_NAME = "BaseMapper";
    private static final String DEFAULT_EXPAND_DAO_SUPER_CLASS = "com.wuzh.commons.mybatis.generator.mapper.BaseExpandMapper";
