...
public class BatchInsertPlugin extends BasePlugin {
    ...
    public boolean validate(List<String> warnings) {
        ...
        // 插件使用前提是数据库为MySQL、MariaDB或者SQLserver，因为返回主键使用了JDBC的getGenereatedKeys方法获取主键
        ...
        if ("com.mysql.jdbc.Driver".equalsIgnoreCase(driverClass) == false
            ...
            warnings.add("itfsw:插件" + this.getClass().getTypeName() + "插件使用前提是数据库为MySQL、MariaDB或者SQLserver，因为返回主键使用了JDBC的getGenereatedKeys方法获取主键！");
            return false;
        }
