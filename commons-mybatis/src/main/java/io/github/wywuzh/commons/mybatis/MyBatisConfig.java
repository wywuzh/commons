...
import io.github.wywuzh.commons.mybatis.constants.DataSourceConstants;
import io.github.wywuzh.commons.mybatis.datasource.DruidDataSourceConfig;
...
public class MyBatisConfig {
     ...
     * MAPPER映射器文件存放路径
     */
    private final String MAPPER_LOCATION = "classpath:io/github/wywuzh/**/mapper/**/*.xml";
    /**
     * MAPPER接口文件存放路径
     *
     * @since v2.3.6
     */
    private final String MAPPER_PACKAGE = "io.github.wywuzh.**.mapper";
    /**
     * 配置文件信息
     */
     ...
     * 实体类所在包
     */
    private final String TYPE_ALIASES_PACKAGE = "io.github.wywuzh.**.entity";
