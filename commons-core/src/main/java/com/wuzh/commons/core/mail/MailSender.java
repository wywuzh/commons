 ...
 */
package com.wuzh.commons.core.mail;
...
public class MailSender {
     ...
     * @throws MessagingException
     */
    public void send(String recipient, String cc, String subject, Object content)
     ...
     * @throws MessagingException
     */
    public void send(String recipient, String cc, String bcc, String subject, Object content)
            throws AddressException, MessagingException {
        Assert.notNull(recipient, "收件人邮箱地址不能为空");
        Assert.notNull(cc, "抄送人邮箱地址不能为空");
     ...
     * @throws MessagingException
     */
    public void send(List<String> recipients, List<String> ccs, String subject, Object content)
            throws AddressException, MessagingException {
        Assert.notEmpty(recipients, "收件人邮箱地址不能为空");
     ...
     * @throws MessagingException
     */
    public void send(List<String> recipients, List<String> ccs, List<String> bccs, String subject, Object content)
            throws AddressException, MessagingException {
        Assert.notEmpty(recipients, "收件人邮箱地址不能为空");
        Assert.notEmpty(ccs, "抄送人邮箱地址不能为空");
