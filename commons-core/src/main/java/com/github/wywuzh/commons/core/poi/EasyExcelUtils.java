...
public class EasyExcelUtils {
    ...
    public static <T> WriteSheet createWriteSheet(String sheetName, String[] columnTitles, Integer[] columnLengths) {
        ...
        WriteSheet writeSheet = EasyExcelFactory.writerSheet(sheetName).registerWriteHandler(new CustomCellWriteHandler(columnLengths)).registerWriteHandler(horizontalCellStyleStrategy).build();
