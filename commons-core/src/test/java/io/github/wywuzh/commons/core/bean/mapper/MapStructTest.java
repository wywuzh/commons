 ...
 */
package io.github.wywuzh.commons.core.bean.mapper;
...
public class MapStructTest {
    ...
    public static interface BeanMapperFactory {
        ...
        @Mappings({
                ...
                @Mapping(target = "birthdateFormat", expression = "java(io.github.wywuzh.commons.core.util.DateUtils.format(user.getBirthdate(), io.github.wywuzh.commons.core.util.DateUtils.PATTERN_DATE_TIME))")
        })
